  ...
  return (
    <div className='relative'>
      ...
      <p>
        ...
        components that we've built in this module!
      </p>
      <p>
      ...
      <p>
        This is the end of the preview. To access the full course and continue
        building the project, click the link below.
      </p>
      <div className='flex w-full justify-center'>
        <Button asChild className='mb-4'>
          <a
            href={
              env.COSDEN_SOLUTIONS_URL +
              '/project-react?utm_source=preview_codebase#pricing'
            }
            target='_blank'
            rel='noreferrer'
          >
